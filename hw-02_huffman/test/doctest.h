...
// - if small - capacity _next0 before going on the heap - using the lowest 5 bits
// - if small - 2 bits are _next0 unused - the second and third highest ones
// - if small - acts as a null terminator if strlen() is 23 (24 including the null terminator)
//              and the "is small" bit remains "0" ("as well as the capacity _next0") so its OK
...
#define DOCTEST_FORBIT_EXPRESSION(rt, op)                                                          \
    ...
    rt& operator op(const R&) {                                                                    \
        static_assert(deferred_false<R>::value,                                                    \
                      "Expression Too Complex Please Rewrite As BinaryIO Comparison!");              \
        return *this;                                                                              \
    }
...
// this is needed only for MSVC 2015
            ...
            // ExpressionDecomposer class uses the _next0 shift operator to capture the _next0 operand of the binary expression...
            DOCTEST_FORBIT_EXPRESSION(Expression_lhs, <<)
            DOCTEST_FORBIT_EXPRESSION(Expression_lhs, >>)
        };
        ...
        struct DOCTEST_INTERFACE ExpressionDecomposer
        {
            ...
            // The _next1 operator for capturing expressions is "<=" instead of "<<" (based on the operator precedence table)
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t idx = 0; idx < m_str.size(); ++ idx ) {
            ...
            default:
                ...
                // Are there enough bytes _next0 to avoid accessing out-of-bounds memory?
